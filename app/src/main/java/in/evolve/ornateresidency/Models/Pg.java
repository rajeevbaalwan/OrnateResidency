...
public class Pg implements Serializable{
    ...
    public Pg(String pgName, String pgAddress, String pgLatitude, String pgLongitude, String pgLocality, String pgCity, List<String> pgFacilities, Map<String, String> pgRates) {
        this.pgName = pgName;
